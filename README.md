...
### 🔶 **P2P Lecture** `⏰ 9:00 A.M. - 12:00 NOON`  
📍 *Location:* Room No F-109   
- A **Dedicated 3 Hour Long** lecture by our **Seniors.**
- Explained about **if, else** & **else-if** statements.
- Covered **for, while** & **do-while** Loop.
- **Crystal Clear** explanation of **post** & **pre increment/decrement** operators.
 
## 🧾 In a Nutshell

| 🕒 Time | 🗂️ Activity | 📌 Key Highlights |
|----------------------|-------------------------|-----------------------------------------------|
| 9:00 AM - 12:00 NOON  | 🔶 P2P Lecture | About Conditions, Loops and increment/decrement operators |
